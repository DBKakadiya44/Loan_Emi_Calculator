...
import com.loan.emi.calculator.databinding.ActivityDocumentsBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.imageView2.setOnClickListener(view -> {
            helper.showCounterInterstitialAd(new InterstitialAD.AdLoadListeners() {
                @Override
                public void onAdLoadFailed() {
                    startActivity(new Intent(DocumentsActivity.this, AadharActivity.class));
                }
        ...
        binding.imageView3.setOnClickListener(view -> {
            helper.showCounterInterstitialAd(new InterstitialAD.AdLoadListeners() {
                @Override
                public void onAdLoadFailed() {
                    startActivity(new Intent(DocumentsActivity.this, Pancard1Activity.class));
                }
        ...
        binding.imageView4.setOnClickListener(view -> {
            helper.showCounterInterstitialAd(new InterstitialAD.AdLoadListeners() {
                @Override
                public void onAdLoadFailed() {
                    startActivity(new Intent(DocumentsActivity.this, VotingActivity.class));
                }
